...
public class MinimumCostGameServiceTest {
    ...
    private void assertTrue(boolean validAssignment) {
    }

    private java.lang.Object times(int i) {
    }

    private void assertEquals(long minimumTotalCost, long minimumTotalCost1) {
    }
