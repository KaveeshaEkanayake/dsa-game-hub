...
class TrafficEdmondsKarpServiceTest {

    private TrafficEdmondsKarpService edmondsKarpService;

    @BeforeEach
    void setUp() {
        edmondsKarpService = new TrafficEdmondsKarpService();
    }
    ...
    void testComputeMaxFlow_returnsPositiveValue() {
        ...
        int maxFlow = edmondsKarpService.computeMaxFlow(edges);
    ...
    void testMeasureTime_returnsNonNegative() {
        List<TrafficEdge> edges = buildSampleGraph();
        long time = edmondsKarpService.measureTime(edges);
    ...
    void testComputeMaxFlow_consistentResults() {
        List<TrafficEdge> edges = buildSampleGraph();
        int firstRun = edmondsKarpService.computeMaxFlow(edges);
        int secondRun = edmondsKarpService.computeMaxFlow(edges);
